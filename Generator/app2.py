...
with st.sidebar:
    ...
    with st.expander("Press Controls", expanded=False):
        ...
        age_4210 = st.slider("4210 KBA106",   1.0, 2.0, 1.15, step=0.05)
        age_4520 = st.slider("4520 Komori",   1.0, 2.0, 1.20, step=0.05)
        age_4360 = st.slider("4360 Komori",   1.0, 2.0, 1.20, step=0.05)
        age_4140 = st.slider("4140 Komori",   1.0, 2.0, 1.25, step=0.05)
        age_4180 = st.slider("4180 840",      1.0, 2.0, 1.30, step=0.05)
        age_4080 = st.slider("4080 KBA105",   1.0, 2.0, 1.50, step=0.05,
