...
def create_control_panel():
    ...
    row = add_var(ws_front, row, "SHARE_4210", 0.30, "4210 KBA106 — Perfecting, fleet workhorse")
    row = add_var(ws_front, row, "SHARE_4180", 0.21, "4180 840 Komori — Sheetfed, short-run specialist")
    row = add_var(ws_front, row, "SHARE_4140", 0.19, "4140 640 Komori — Sheetfed")
    row = add_var(ws_front, row, "SHARE_4520", 0.16, "4520 640 Komori — Sheetfed")
    row = add_var(ws_front, row, "SHARE_4360", 0.08, "4360 640 Komori — Sheetfed")
    row = add_var(ws_front, row, "SHARE_4080", 0.06, "4080 KBA105 — Perfecting, most unreliable")
    row = row + 1
    ...
    row = add_var(ws_back, row, "AGE_FACTOR_4210", 1.15, "4210 KBA106 — Perfecting, best maintained")
    row = add_var(ws_back, row, "AGE_FACTOR_4520", 1.20, "4520 640 Komori — Sheetfed, solid throughput")
    row = add_var(ws_back, row, "AGE_FACTOR_4360", 1.20, "4360 640 Komori — Sheetfed, consistent")
    row = add_var(ws_back, row, "AGE_FACTOR_4140", 1.25, "4140 640 Komori — Sheetfed, middle of road")
    row = add_var(ws_back, row, "AGE_FACTOR_4180", 1.30, "4180 840 Komori — Sheetfed, heavy short-run use")
    row = add_var(ws_back, row, "AGE_FACTOR_4080", 1.50, "4080 KBA105 — Perfecting, most unreliable")
    row = row + 1
