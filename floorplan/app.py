...
if not st.session_state.authenticated:
    st.markdown(f"""
        ...
        height:60vh;gap:1rem;">
            ...
            Press Room Decision Engine</div>
        </div>
    """, unsafe_allow_html=True)
...
with col_head:
    st.markdown(f"""
        ...
        <div style="color:{C_MUTED}; font-size: 0.8rem; margin-top: 0.1rem; margin-bottom: 0.3rem;">Press Room Decision Engine</div>
...
# ── FOOTER ────────────────────────────────────────────────────────────────
st.markdown("<hr>", unsafe_allow_html=True)
st.markdown(f"<div style='color:{C_MUTED};font-size:0.7rem;'>FloorPlan v1.0 · Press Room · Calibrated Q1–May 2026</div>", unsafe_allow_html=True)
