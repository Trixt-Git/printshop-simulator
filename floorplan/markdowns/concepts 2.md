...
**Real world analogy**
If every department in the plant kept their own copy of the press schedule and updated it independently, they'd always be out of sync. One shared schedule that everyone reads from is DRY.
...
**Where it lives in FloorPlan**
Rolling 90-day average — `last_3_months = [p for p in all_presses if p.press_id == "4210"][-3:]`
